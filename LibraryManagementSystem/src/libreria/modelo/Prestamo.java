...
public class Prestamo {
    ...
    public Prestamo(int idPrestamo, int usuarioId, int libroId, Date fechaPrestamo, Date fechaDevolucion, boolean estadoDevuelto) {
    ...
    // Constructor con solo usuarioId y libroId (para crear préstamo sin fechas ni estado)
    ...
    // Constructor con usuarioId, libroId y fechaPrestamo (sin fechaDevolucion y estado)
